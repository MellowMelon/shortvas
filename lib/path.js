...
sPathProto.moveTo = liftFlatten(function (x, y) {
  this.x = x;
  this.y = y;
...
// Relative version
sPathProto.m = liftFlatten(function (dx, dy) {
  return this.moveTo(this.x + dx, this.y + dy);
});
// Aliases
sPathProto.M = sPathProto.moveTo;

sPathProto.lineTo = liftFlatten(function (x, y) {
  this.x = x;
  this.y = y;
...
// Relative version
sPathProto.l = liftFlatten(function (dx, dy) {
  return this.lineTo(this.x + dx, this.y + dy);
});
// Aliases
sPathProto.L = sPathProto.lineTo;

sPathProto.closePath = liftFlatten(function () {
...
sPathProto.H = liftFlatten(function (x) {
  this.x = x;
  this.context.lineTo(x, this.y);
  return this;
});
// Relative version
sPathProto.h = liftFlatten(function (dx) {
  return this.H(this.x + dx);
});

sPathProto.V = liftFlatten(function (y) {
  this.y = y;
  this.context.lineTo(this.x, y);
  return this;
});
// Relative version
sPathProto.v = liftFlatten(function (dy) {
  return this.V(this.y + dy);
});

sPathProto.quadraticCurveTo = liftFlatten(function (cpx, cpy, x, y) {
  this.x = x;
  this.y = y;
...
// Relative version
sPathProto.q = liftFlatten(function (dcpx, dcpy, dx, dy) {
...
sPathProto.bezierCurveTo = liftFlatten(function (cp1x, cp1y, cp2x, cp2y, x, y) {
  this.x = x;
  this.y = y;
...
// Relative version
sPathProto.c = liftFlatten(function (dcp1x, dcp1y, dcp2x, dcp2y, dx, dy) {
...
sPathProto.rect = liftFlatten(function (x, y, width, height) {
  this.x = x;
  this.y = y;
...
sPathProto.arc = liftFlatten(function (x, y, r, start, end, ccw) {
...
sPathProto.arcTo = liftFlatten(function (cp1x, cp1y, cp2x, cp2y, r) {
